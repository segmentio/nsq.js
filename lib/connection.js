...
Connection.prototype.finish = function(id, fn){
  ...
  var self = this;
  if (!this._ready) return this.onerror(new Error('cannot finish, connection not ready'));
...
Connection.prototype.touch = function(id, fn){
  assertValidMessageId(id);
  var self = this;
  if (!this._ready) return this.onerror(new Error('cannot touch, connection not ready'));
