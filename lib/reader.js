...
Reader.prototype.connect = function(){
  ...
  else this.lookup(this.nsqlookupd, this.topic);
};

/**
 * Lookup nsqd nodes via nsqlookupd `addrs`, filtering
 * nodes producing messages for `topic`.
 *
 * @param {Array} addrs
 * @param {String} topic
 * @api private
...
Reader.prototype.lookup = function(addrs, topic){
  var self = this;
...
Reader.prototype.connectTo = function(addrs){
  addrs.forEach(this.connectNode.bind(this));
};
